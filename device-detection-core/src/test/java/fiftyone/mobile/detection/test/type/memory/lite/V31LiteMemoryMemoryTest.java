...
public class V31LiteMemoryMemoryTest extends MemoryBase {

    public V31LiteMemoryMemoryTest() {
        super(Filename.LITE_PATTERN_V31);
    }

    @Test
    @Category(TestType.DataSetLite.class)
    public void LiteV31Memory_Memory_UniqueUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getUniqueUserAgents(), 200);
    }

    @Test
    public void LiteV31Memory_Memory_UniqueUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getUniqueUserAgents(), 200);
    }

    @Test
    public void LiteV31Memory_Memory_RandomUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getRandomUserAgents(), 200);
    }

    @Test
    public void LiteV31Memory_Memory_RandomUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getRandomUserAgents(), 200);
    }

    @Test
    public void LiteV31Memory_Memory_BadUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getBadUserAgents(), 200);
    }

    @Test
    public void LiteV31Memory_Memory_BadUserAgentsSingle() throws IOException {
