...
public class V32PremiumArrayTest extends ArrayBase {

    public V32PremiumArrayTest() {
        super(Filename.PREMIUM_PATTERN_V32);
    }

    @Test
    @Category(TestType.DataSetPremium.class)
    public void PremiumV32Array_Memory_UniqueUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getUniqueUserAgents(), 110);
    }

    @Test
    public void PremiumV32Array_Memory_UniqueUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getUniqueUserAgents(), 110);
    }

    @Test
    public void PremiumV32Array_Memory_RandomUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getRandomUserAgents(), 110);
    }

    @Test
    public void PremiumV32Array_Memory_RandomUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getRandomUserAgents(), 110);
    }

    @Test
    public void PremiumV32Array_Memory_BadUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getBadUserAgents(), 110);
    }

    @Test
    public void PremiumV32Array_Memory_BadUserAgentsSingle() throws IOException {
