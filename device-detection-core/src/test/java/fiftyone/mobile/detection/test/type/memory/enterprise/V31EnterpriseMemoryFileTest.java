...
import fiftyone.mobile.detection.test.type.memory.FileBase;
...
public class V31EnterpriseMemoryFileTest extends FileBase {

    public V31EnterpriseMemoryFileTest() {
        super(Filename.ENTERPRISE_PATTERN_V31);
    }

    @Test
    @Category(TestType.DataSetEnterprise.class)
    public void EnterpriseV31File_Memory_UniqueUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getUniqueUserAgents(), 30);
    }

    @Test
    public void EnterpriseV31File_Memory_UniqueUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getUniqueUserAgents(), 30);
    }

    @Test
    public void EnterpriseV31File_Memory_RandomUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getRandomUserAgents(), 30);
    }

    @Test
    public void EnterpriseV31File_Memory_RandomUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getRandomUserAgents(), 30);
    }

    @Test
    public void EnterpriseV31File_Memory_BadUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getBadUserAgents(), 80);
    }

    @Test
    public void EnterpriseV31File_Memory_BadUserAgentsSingle() throws IOException {
