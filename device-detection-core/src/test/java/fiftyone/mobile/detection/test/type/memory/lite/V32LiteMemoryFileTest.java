...
public class V32LiteMemoryFileTest extends FileBase {

    public V32LiteMemoryFileTest() {
        super(Filename.LITE_PATTERN_V32);
    }

    @Test
    @Category(TestType.DataSetLite.class)
    public void LiteV32File_Memory_UniqueUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getUniqueUserAgents(), 20);
    }

    @Test
    public void LiteV32File_Memory_UniqueUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getUniqueUserAgents(), 20);
    }

    @Test
    public void LiteV32File_Memory_RandomUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getRandomUserAgents(), 20);
    }

    @Test
    public void LiteV32File_Memory_RandomUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getRandomUserAgents(), 20);
    }

    @Test
    public void LiteV32File_Memory_BadUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getBadUserAgents(), 50);
    }

    @Test
    public void LiteV32File_Memory_BadUserAgentsSingle() throws IOException {
