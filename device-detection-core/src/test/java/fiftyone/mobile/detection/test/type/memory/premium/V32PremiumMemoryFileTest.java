...
public class V32PremiumMemoryFileTest extends FileBase {

    public V32PremiumMemoryFileTest() {
        super(Filename.PREMIUM_PATTERN_V32);
    }

    @Test
    @Category(TestType.DataSetPremium.class)
    public void PremiumV32File_Memory_UniqueUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getUniqueUserAgents(), 20);
    }

    @Test
    public void PremiumV32File_Memory_UniqueUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getUniqueUserAgents(), 20);
    }

    @Test
    public void PremiumV32File_Memory_RandomUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getRandomUserAgents(), 20);
    }

    @Test
    public void PremiumV32File_Memory_RandomUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getRandomUserAgents(), 20);
    }

    @Test
    public void PremiumV32File_Memory_BadUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getBadUserAgents(), 70);
    }

    @Test
    public void PremiumV32File_Memory_BadUserAgentsSingle() throws IOException {
