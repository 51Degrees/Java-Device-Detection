...
public class V31PremiumPerformanceFileTest extends FileBase {
    ...
    {
        super.badUserAgentsMulti(null, 5);
    }

    @Test
    public void badUserAgentsSingle() throws IOException
    {
        super.badUserAgentsSingle(null, 10);
    }
    ...
    {
        super.badUserAgentsMulti(super.dataSet.properties, 6);
    }

    @Test
    public void badUserAgentsSingleAll() throws IOException
    {
        super.badUserAgentsSingle(super.dataSet.properties, 10);
    }
