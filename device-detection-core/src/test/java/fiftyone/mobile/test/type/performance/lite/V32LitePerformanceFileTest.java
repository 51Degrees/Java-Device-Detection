...
package fiftyone.mobile.test.type.performance.lite;
...
public class V32LitePerformanceFileTest extends FileBase {
    public V32LitePerformanceFileTest() {
    ...
    {
        super.badUserAgentsMulti(super.dataSet.properties, 5);
    }
