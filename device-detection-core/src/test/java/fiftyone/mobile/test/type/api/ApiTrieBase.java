...
public abstract class ApiTrieBase extends DetectionTestSupport {
    ...
    public void allHeaders() throws Exception {
        ...
        for (String header : getProvider().getHttpHeaders()) {
            headers.put(header, fiftyone.mobile.test.common.UserAgentGenerator.getRandomUserAgent(0));
        }
    ...
    public void longUserAgent() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            sb.append(fiftyone.mobile.test.common.UserAgentGenerator.getRandomUserAgent(10));
        }
