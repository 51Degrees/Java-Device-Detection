...
public abstract class TrieBase extends DetectionTestSupport {
    ...
    protected fiftyone.mobile.test.common.Results userAgentMulti(Iterable<String> userAgents) {
        return Results.detectLoopMultiThreaded(provider, userAgents);
    }
    
    protected fiftyone.mobile.test.common.Results userAgentmultiAll(Iterable<String> userAgents) {
    ...
    protected fiftyone.mobile.test.common.Results userAgentsSingle(Iterable<String> userAgents) {
        return Results.detectLoopSingleThreaded(provider, userAgents);
    }
    
    protected fiftyone.mobile.test.common.Results userAgentsSingleAll(Iterable<String> userAgents) {
