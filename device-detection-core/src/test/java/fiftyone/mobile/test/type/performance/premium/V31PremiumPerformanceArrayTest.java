...
import fiftyone.mobile.test.type.performance.ArrayBase;
...
public class V31PremiumPerformanceArrayTest extends ArrayBase {
    ...
    {
        super.badUserAgentsMulti(null, 3);
    }
    ...
    {
        super.badUserAgentsMulti(super.dataSet.properties, 4);
    }

    @Test
    public void badUserAgentsSingleAll() throws IOException
    {
        super.badUserAgentsSingle(super.dataSet.properties, 5);
    }
