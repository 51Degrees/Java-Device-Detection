...
public class V32ArrayTest extends ArrayBase {
    ...
    @Test
    public void LiteV32Array_Memory_UniqueUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getUniqueUserAgents(), 60);
    }

    @Test
    public void LiteV32Array_Memory_RandomUserAgentsMulti() throws IOException {
        super.userAgentsMulti(UserAgentGenerator.getRandomUserAgents(), 60);
    }

    @Test
    public void LiteV32Array_Memory_RandomUserAgentsSingle() throws IOException {
        super.userAgentsSingle(UserAgentGenerator.getRandomUserAgents(), 60);
    }

    @Test
    public void LiteV32Array_Memory_BadUserAgentsMulti() throws IOException {
