 ...
 * as required.
 * <p>
 * This class provides core functions needed for lists which load objects as
 * required. It implements the Cache<T> to store frequently requested objects
 * and improve memory usage and performance.
 * <p>
 * Interface implementations are used to create new instances of items to add to
 * the list in order to avoid creating many inherited list classes for each
 * BaseEntity type.
 * <p>
...
public abstract class BaseList<T extends BaseEntity> implements
	 ...
	 * @param source
	 *            Source data file containing the entire data structure
	 */
	 ...
	 * 
	 * @param offsetOrIndex
	 *            Index or offset of the record required
