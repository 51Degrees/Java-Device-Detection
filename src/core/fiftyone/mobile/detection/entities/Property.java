 ...
 * <p>
 * Some properties are not mandatory and may not always contain values. For
 * example; information concerning features of a television may not be
 * applicable to a mobile phone. The IsMandatory property should be checked
 * before assuming a value will be returned.
 * <p>
 ...
 * IsList is false will only return up to one value.
 * <p>
 * The property also provides other information about the intended use of the
 * property. The Description can be used by UI developers to provide more
 * information about the intended use of the property and it's values. The
 * Category property can be used to group together related properties in
 * configuration UIs.
 * <p>
 * Values are returned in the type Values which includes utility methods to
 * easily extract strongly typed values.
 * <p>
