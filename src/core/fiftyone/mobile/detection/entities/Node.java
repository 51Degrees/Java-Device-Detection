...
public class Node extends BaseEntity implements Comparable<Node> {
	 ...
	 *            to start reading
	 * @param count
	 * 			  The number of elements to read into the array
	...
	/**
	 * Provides an iterator which provides the closest numeric children 
	 * to the target is ascending order of difference
	 ...
	 * @param array 
	 * 				Array of characters with numeric characters present
	 ...
	 * @param match 
	 * 			results including the target user agent
	 ...
	 * @return -1 if this node is lower than the other, 1 if higher or 
	 * 0 if equal.
	 */
