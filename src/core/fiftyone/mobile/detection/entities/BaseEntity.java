...
public class BaseEntity {
	 ...
	 * 
	 * @param dataSet
	 *            The data set the item is contained within
	 * @param index
	 *            The index of the item within the dataset
	 */
	 ...
	 * @return The index of the entity in the list or twos complement of insert index
	 */
