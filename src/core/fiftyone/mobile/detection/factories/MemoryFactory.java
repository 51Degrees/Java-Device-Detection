 ...
 * consistent. The performance of the data set will be very fast compared to the
 * stream based implementation as all required data is loaded into memory and
 * references between related objects set at initialisation. However overall
 * memory usage will be higher than the stream based implementation on lightly
 * loaded environments.
 * <p>
 ...
 * initialisation is not performed then references will be calculated when
