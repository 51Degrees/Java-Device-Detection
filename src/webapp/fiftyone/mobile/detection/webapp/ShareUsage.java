...
class ShareUsage implements Runnable {
	 ...
	 * 
	 * @param newDevicesUrl
	 *            Url of potential new host.
	 * @param newDeviceDetail
	 *            Controls how much data is sent.
	 */
	 ...
	 * 
	 * @param Headers
	 *            HashMap containing the request headers.
	 * @param HostAddress
	 *            the Host Address.
	 * @param URI
	 ...
	 * 
	 * @param Headers
	 *            A Map of the connection headers.
	 * @param HostAddress
	 *            The address ip Address of the host.
	 * @param URI
	 *            The URI information.
	 * @param newDeviceDetail
	 *            How much information to be recorded.
